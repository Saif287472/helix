...
// Extracts: Flutter app source (lib/** + pubspec), excluding windows plugin symlinks
// Output:   helix/docs/codebase/local_1_app.txt
...
void main() async {
  ...
  await _write(
    docsDir: docsDir,
    name: 'local_1_app',
    title: 'HELIX-LOCAL  ·  FLUTTER APP',
    subtitle:
        'main · composition root · providers (app, identity, session, messaging, groups, discovery, transfer, wipe) · UI screens · widgets · components',
    repoRoot: repoRoot,
    files: files,
  );
}
