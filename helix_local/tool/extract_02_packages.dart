...
// Extracts: all helix_local packages (lib/** + pubspec per package)
// Output:   helix/docs/codebase/local_2_packages.txt
...
void main() async {
  ...
  await _write(
    docsDir: docsDir,
    name: 'local_2_packages',
    title: 'HELIX-LOCAL  ·  PACKAGES',
    subtitle:
        'domain · protocol (frames, codec, versioning) · crypto · transport · storage · messaging · transfer · calls · discovery · groups · platform',
    repoRoot: repoRoot,
    files: files,
  );
}
