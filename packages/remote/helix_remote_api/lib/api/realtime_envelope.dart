class RemoteRealtimeEnvelope {
  ...
  factory RemoteRealtimeEnvelope.fromJson(Map<String, dynamic> json) {
    ...
    if (eventId == null || schemaVersion == null || timestamp == null || type == null) {
      throw FormatException('Missing required envelope fields: event_id, schema_version, timestamp, or type');
    }

    final Map<String, dynamic> parsedPayload = payloadObj is Map<String, dynamic>
        ? payloadObj
        : <String, dynamic>{};
