...
void main() {
  ...
  // Removed (2026-06-24): "Outbound Queue processing with success and backoff fail" —
  // duplicate of RP3-004/RP3-005 in app/test/remote_sync_engine_test.dart, which tests
  // the same backoff/retry logic with more structured coverage.
  //
  // Removed (2026-06-24): "P09 emits state changes for inbound sync and outbox updates" —
  // duplicate of the changes-emission assertions throughout RP3-001/RP3-002 groups in
  // app/test/remote_sync_engine_test.dart.
