...
void main() {
  ...
  test('Real-time Message Exchange over WebSockets and Outbox Processing', () async {
    ...
    await aliceClient.publishPrekeys(restClient: aliceRestClient, oneTimePrekeysCount: 5);
    ...
    expect(bobReceived['msg_001'], equals('Hello Bob! Sending this over WebSocket.'));
    ...
    expect(aliceReceived['msg_002'], equals('Hi Alice! Received and decrypted successfully.'));
