...
// Extracts: Flutter admin app (lib/**) + helix_remote_cli package (bin/ + lib/**)
// Output:   helix/docs/codebase/remote_6_admin_and_cli.txt
...
void main() async {
  ...
  _addFile(files, repoRoot, 'admin/pubspec.yaml');
  ...
  await _write(
    docsDir: docsDir,
    name: 'remote_6_admin_and_cli',
    title: 'HELIX-REMOTE  ·  ADMIN APP + CLI',
    subtitle:
        'admin (Flutter ops console) · helix_remote_cli (bin/ entrypoint + client, REST, secure storage)',
    repoRoot: repoRoot,
    files: files,
  );
}
