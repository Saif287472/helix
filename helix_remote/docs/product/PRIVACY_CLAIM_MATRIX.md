...
| No mandatory address-book upload | Implemented | App never requests contacts permission; no upload path in codebase | Verified in `docs/product/PRIVACY_POLICY.md` |
