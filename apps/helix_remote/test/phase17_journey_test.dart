...
void main() {
  ...
  group('P17-J01 ConversationList → Conversation navigation journey', () {
    ...
    testWidgets('ConversationScreen (Phase 12) call buttons are gated', (
      ...
      // callsAvailable: false → both call icons are present but disabled
      await tester.pumpWidget(
        MaterialApp(
          home: ConversationScreen(
            conversationId: 'dm_alice_bob',
      ...
      final audioBtn = tester.widget<IconButton>(
        find.widgetWithIcon(IconButton, Icons.call),
      );
      expect(audioBtn.onPressed, isNull);
    });
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.tap(find.widgetWithIcon(IconButton, Icons.call));
