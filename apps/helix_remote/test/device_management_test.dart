...
void main() {
  group('P14-W01 DeviceManagementScreen reachability', () {
    ...
    testWidgets('Link New Device shows unavailable banner', (tester) async {
      await tester.pumpWidget(_makeApp(_StubRestClient()));
      await tester.pump();
    ...
    testWidgets('security history dialog shows events', (tester) async {
      ...
      expect(find.text('Sec Phone History'), findsOneWidget);
