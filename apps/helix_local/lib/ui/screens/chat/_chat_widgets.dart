...
class _PinnedRail extends StatelessWidget {
  ...
  final ValueChanged<ChatMessage> onChipTap;
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(
            icon: Icon(
              collapsed ? Icons.push_pin_outlined : Icons.push_pin,
              size: 18,
            ),
            tooltip: collapsed ? 'Show pinned' : 'Collapse pinned',
