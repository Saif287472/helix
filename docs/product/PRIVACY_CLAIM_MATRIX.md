...
| **Secure Reset** | Implemented | Clear secure storage, memory tables, WAL buffers | Implemented for server account deletion | Account delete endpoint purges server-side account/device/mailbox data; external copies remain out of scope |
